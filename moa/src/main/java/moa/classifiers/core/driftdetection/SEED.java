...
public class SEED extends AbstractMOAObject{

	private class SEEDBlock extends AbstractMOAObject{
		protected SEEDBlock next;
		protected SEEDBlock previous;
	...
	private class SEEDWindow extends AbstractMOAObject{
		protected SEEDBlock head;
		protected SEEDBlock tail;
		...
		protected int DECAY_MODE = 1;
		protected final int LINEAR_DECAY = 1;
		protected final int EXPONENTIAL_DECAY = 2;

		protected int COMPRESSION_MODE = 1;
		protected final int FIXED_TERM = 1;

		protected int decayCompressionCount = 0;
		protected int linearFixedTermSize = 50;

		protected double epsilonPrime = 0.0;
